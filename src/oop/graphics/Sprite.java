...
public class Sprite {
    ...
    //map 1 
	public static Sprite grass1 = new Sprite(16, 6, 2, SpriteSheet1.tiles, 16, 16);
	public static Sprite brick1 = new Sprite(16, 7, 0, SpriteSheet.tiles, 16, 16);
	public static Sprite treasure = new Sprite(16, 12, 4, SpriteSheet1.tiles, 16, 16);
	public static Sprite wall1= new Sprite(16, 5, 13, SpriteSheet1.tiles, 16, 16);
	public static Sprite portal = new Sprite(16, 1, 13, SpriteSheet1.tiles, 14, 14);
	
	//map 2 portal2 giống portal 1
	public static Sprite grass2 = new Sprite(16, 0, 1, SpriteSheet1.tiles, 16, 16);
	public static Sprite brick2 = new Sprite(16, 3, 15, SpriteSheet1.tiles, 16, 16);
	public static Sprite wall2= new Sprite(16, 6, 15, SpriteSheet1.tiles, 16, 16);

	
	//map 3 portal 3 giống portal 1
	public static Sprite grass3 = new Sprite(16, 0, 7, SpriteSheet1.tiles, 16, 16);
	public static Sprite brick3 = new Sprite(16, 14, 4, SpriteSheet1.tiles, 16, 16);
	public static Sprite wall3= new Sprite(16, 1, 5, SpriteSheet1.tiles, 16, 16);
	
	//map 4  wall 4 giống wall 1
	public static Sprite grassl = new Sprite(16, 5, 12, SpriteSheet1.tiles, 16, 16);
	public static Sprite grassr = new Sprite(16, 6, 12, SpriteSheet1.tiles, 16, 16);
	public static Sprite door4 = new Sprite(16, 4, 0, SpriteSheet.tiles, 16, 16);
	public static Sprite grass4 = new Sprite(16, 4, 15, SpriteSheet1.tiles, 16, 16);
	public static Sprite floor4 = new Sprite(16, 5, 0, SpriteSheet.tiles, 16, 16);
	public static Sprite portal4 = new Sprite(16, 8, 7, SpriteSheet1.tiles, 14, 14);
